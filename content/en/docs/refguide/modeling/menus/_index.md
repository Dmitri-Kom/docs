...
| **Support Tools** | Provides a variety of tools (such as: performance logging & profiling) that can be used to share with Mendix Support, especially when you encounter issues with performance or high memory consumption. see [Support Tools Menu](/refguide/support-tools-menu/).   |   |
